...
18.
19.	git remote add origin https://github.com/Martin937/beOnJs.git	Прописываем путь к github
20.	git remote set-url origin https://github.com/Martin937/beOnJs.git	Если нужно изменить уже существующий
